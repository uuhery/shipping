...
import com.company.project.service.sys.PermissionService;
...
import com.company.project.utilities.exception.code.BaseResponseCode;
...
public class PermissionController {
    ...
    @PreAuthorize("hasAnyAuthority('sys:permission:update', 'sys:permission:add')")
